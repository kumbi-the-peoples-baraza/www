...
export default function About() {
  ...
  return (
    <>
      <PageHero title="About Kumbi" subtitle="The People's Baraza — a civic technology organisation rooted in Nairobi, Kenya."
        tag="Who We Are" img={cfg.pages.about.heroImage} />
      ...
      <div className="px-[2%] sm:px-[4%] lg:px-[6%] max-w-7xl mx-auto py-16 flex flex-col gap-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            {values.map((v, i) => (
              <motion.div key={v.title} initial={{ opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }}
